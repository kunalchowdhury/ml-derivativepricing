...
algorithm_name=ml-workshop-deriv-pricing

get_ipython().run_line_magic('cd', 'container')

get_ipython().system('chmod +x keras-regression/train')
get_ipython().system('chmod +x keras-regression/serve')
