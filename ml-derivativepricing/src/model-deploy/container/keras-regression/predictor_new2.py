...
def evaluate():
    ...
    if flask.request.content_type == "application/json":
        ...
        lambda_client = boto3.client('lambda', aws_access_key_id='AKIAYEYVUNNZCNEXLGU5' ,aws_secret_access_key='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', region_name='us-east-1')
        ...
        for dict in parsed:
            try:
                ...
                #print(predicted_npv)
                valuation_results['from_keras'][ins_id] = predicted_npv[0][0]
                diff = 0;
                ...
                valuation_results['diff_pc'][ins_id] = diff * 100
        ...
        for r in valuation_results['from_quantlib']:
            ...
            ins_data['actual']= str(valuation_results['from_quantlib'][r])
            ins_data['predicted']= str(valuation_results['from_keras'][r])
            ins_data['diff']= str(valuation_results['diff_pc'][r])

            actual_dict[i] =  float(valuation_results['from_quantlib'][r])
            pred_dict[i] =    valuation_results['from_keras'][r]
            i = i + 1
